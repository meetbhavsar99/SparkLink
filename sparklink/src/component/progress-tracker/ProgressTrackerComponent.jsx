...
const ProgressTrackerComponent = () => {
  ...
  const handleAddMilestone = () => {
    setMilestoneList([
      ...milestoneList,
      { proj_id: "", milestone_desc: "", milestone_title: "", end_date: "" },
    ]);
  ...
  const fetchSuggestions = async (query) => {
    ...
    try {
      const response = await axios.get(
        "/progressTracker/filterProjMilestones",
        {
      ...
      if (result.isConfirmed) {
        ...
        try {
          const response = await axios.post(
            "/progressTracker/deleteMilestone",
            {
              milestoneList: detailsList,
            }
          );
  ...
  const completeMilestone = async () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        try {
          const response = await axios.post(
            "/progressTracker/completeMilestone",
            {
              milestoneList: detailsList,
            }
          );
  ...
  const resumeMilestone = async () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        try {
          const response = await axios.post(
            "/progressTracker/resumeMilestone",
            {
              milestoneList: detailsList,
            }
          );
                            ...
                            Array.isArray(milestoneData) && (
                              <div className="row">
                                {milestoneData.map((milestone, index) => {
                                  let backgroundColor;
                                  const milestoneEndDate = new Date(
                                    milestone.end_date
                                  )
                                    .toISOString()
                                    .split("T")[0];
                                  ...
                                  if (
                                    milestoneEndDate < today &&
                                    milestone.is_completed === "N"
                                  ) {
                                  ...
                                  return (
                                    <div
                                      className="col-12 col-md-4 col-lg-2 mb-4 mt-3"
                                      key={index}
                                    >
                                      <div
                                        className="box"
                                      ...
                                      >
                                        <div className="header">
                                          {/* <span className="icon">{index + 1}</span>
                                                                            &nbsp; */}
                                          <span className="milestone_title_text">
                                            {milestone.milestone_title.length >
                                            20
                                              ? `${milestone.milestone_title.slice(
                                                  0,
                                                  18
                                                )}...`
                                        ...
                                        <span className="milestone_text">
                                          {milestone.end_date}
                                        </span>
                                        <p className="milestone_text">
                                          {milestone.milestone_desc.length > 50
                                            ? `${milestone.milestone_desc.slice(
                                                0,
                                                18
                                              )}...`
                              ...
                              <tbody>
                                ...
                                {milestoneList.map((milestone, index) => (
                                  <tr
                                    ...
                                    className="row milestone-item text-center"
                                  >
                                          ...
                                          {!editFlag && (
                                            <>
                                              <td className="text-center">
                                                {detailsList.milestone_title}
                                              </td>
                                              <td className="text-center">
                                                {detailsList.milestone_desc}
                                              </td>
                                              <td className="text-center">
                                                {detailsList.end_date}
                                              </td>
                                              {(accessVal === "S" ||
                                                accessVal === "SU") && (
                                                <td className="text-center">
