...
const AboutComponent = () => {
  ...
  const currentTeam = [
    {
      ...
      responsibilities:
        "Led the development team, built the backend for the entire application, developed a fully functional frontend, and improved the UI for a better user experience.",
      image: Meet,
    ...
    },
    {
      ...
      responsibilities:
        "Worked on Virtual Machine setup and deployment, contributed to frontend development, and implemented UI enhancements to improve the application’s design and usability.",
      image: Chaitanya,
    ...
    },
    {
      ...
      responsibilities:
        "Assisted with UI refinements, ensured consistency in the design, and prepared comprehensive project documentation, including reports and presentations.",
      image: Heet,
  ...
  const previousTeam = [
    ...
    },
    {
      ...
      responsibilities:
        "Assisted front-end team, created About Us page, and writing test cases.",
      image: Micheal,
    ...
    },
    {
      ...
      responsibilities:
        "Created the Project screen and worked on front-end components.",
      image: Joshua,
    ...
    },
    {
      ...
      responsibilities:
        "Designed the mobile UI and implemented the recommendation system.",
      image: Aman,
      LinkedIn: "",
    },
  ];
        ...
        <div className="content-wrapper">
          ...
          <section className="project-overview">
            ...
            <p className="project-title">
              <strong>Project Title:</strong> UWindsor SparkLink – Empowering IT
              Solutions through Student Innovation
            </p>
            <p className="project-description">
              UWindsor SparkLink is a platform designed to connect University of
              Windsor departments with Computer Science students for IT project
              support. It provides hands-on experience to students while solving
              departmental IT challenges. Key features include project
              submission, skill-based matching, and paid opportunities for
              students.
            </p>
          </section>
            ...
            {showProfessor && (
              <div className="team-grid">
                <div className="team-card">
                  ...
                  <p>
                    <strong>Supervised the entire project</strong>
                  </p>
                </div>
              </div>
            )}
                    ...
                    <div className="social-icons">
                      ...
                      <a
                        ...
                        className={`icon-email ${
                          !member.Email ? "disabled-link" : ""
                        }`}
                        title={
                          member.Email ? "Send an Email" : "No email available"
                        }
                      >
                        <img
                          src={mail_icon}
