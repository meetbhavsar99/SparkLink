  ...
  const openProjectDetails = (projId) => {
    ...
    for (let i = 0; i < projectList.length; i++) {
      if (projectList[i].proj_id === projId) {
        ...
        if (
          filteredProj.stakeholder &&
          Array.isArray(filteredProj.stakeholder)
        ) {
          filteredProj.stakeholder = filteredProj.stakeholder.map(
            (stakeholder) => ({
              ...stakeholder,
  ...
  const fetchUserRoles = async () => {
    ...
    try {
      ...
      Swal.fire({
        title: "Error",
        text:
          error.response?.data?.message || "Error fetching access permissions",
        icon: "error",
        confirmButtonText: "Ok",
      });
                  ...
                  <div className="progress-tracker">
                    ...
                    <div className="pagination-container">
                      ...
                      <span className="pagination-text">
                        {" "}
                        Page {currentPage} of{" "}
                        {Math.ceil(projectList.length / projectsPerPage)}{" "}
                      </span>
                    ...
                    <Table responsive="sm" bordered hover>
                      <tbody>
                        ...
                        <tr>
                          ...
                          {!editFlag && (
                            <td className="proj-details-data">
                              {Math.trunc(projDetailsList.budget)}
                            </td>
                          )}
                          {editFlag && (
                            <td className="proj-details-data">
                          ...
                          {editFlag && (
                            <td className="proj-details-data">
                              <input
                                ...
                                value={
                                  projDetailsList.end_date
                                    ? projDetailsList.end_date.split("T")[0]
                                    : ""
                                }
                                onChange={(e) =>
                                  handleUpdateProjDetailsChange(e)
                        ...
                        {projDetailsList.files &&
                          projDetailsList.files.length > 0 && (
                            <tr>
