    ...
    const slides = [
        {
            ...
            subCaption: "Gain Hands-On Skills, Build a Portfolio, and Earn Money by Solving IT Problems Across Campus"
        },
        {
            image: Homepage_2,
            caption: "Empowering IT Solutions for Campus Needs",
            subCaption: "Connecting University of Windsor Departments with Talented Students to Tackle Tech Challenges"
        },
        {
            image: Homepage_3,
            caption: "Simplifying Collaboration and Project Management",
            subCaption: "Seamlessly Match Departments with Skilled Students to Complete Technology Projects Efficiently"
        }
    ];
                    ...
                    <div className="home_container">
                        ...
                        <div className="features-section">
                            <div className="section-header">
                                ...
                                <p>Discover the tools and benefits designed to help you grow and succeed.</p>
                            </div>
